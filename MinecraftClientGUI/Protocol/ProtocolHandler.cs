...
namespace MinecraftClient.Protocol
{
    ...
    public static class ProtocolHandler
    {
        ...
        {
            string result = "";
            string cookies = String.Format("sid=token:{0}:{1};user={2};version={3}", accesstoken, uuid, username, MinecraftClient.Login.MCHighestVersion);
        ...
        private static int DoHTTPSPost(string host, string endpoint, string request, ref string result)
        {
            ...
            http_request.Add("Host: " + host);
            http_request.Add("User-Agent: MCC/" + MinecraftClient.Login.Version);
