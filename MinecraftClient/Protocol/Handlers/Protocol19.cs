    ...
    class Protocol18Handler : IMinecraftCom
    {
        ...
        private bool handlePacket(int packetID, List<byte> packetData)
        {
            ...
            switch (packetID)
            {
                ...
                case 0x0F: //Chat message
                    ...
                    break;
                case 0x2E: //Player Position and Look
                    if (Settings.TerrainAndMovements)
                    {
                        ...
                        //needs to handle Teleport ID	(VarInt)
                ...
                case 0x0B: //Block Change
                    ...
                    break;
                //case 0x26: //Map Chunk Bulk //Replaced by multiple Chunk Data packets.
                case 0x2D: //Player List update(Item?)
                    if (protocolversion >= MC18Version)
                    {
                ...
                case 0x40: //Kick Packet
                    ...
                    return false;
                case 0x1A: //Network Compression Treshold Info
                    if (protocolversion >= MC18Version)
                        compression_treshold = readNextVarInt(packetData);
                    break;
                case 0x32: //Resource Pack Send
        ...
        public bool SendChatMessage(string message)
        {
            ...
            try
            {
                ...
                SendPacket(0x02, message_packet);
                return true;
            }
            catch (SocketException) { return false; }
        ...
        public bool SendPluginChannelPacket(string channel, byte[] data)
        {
            try
            {
                ...
                if (protocolversion < MC18Version)
                {
                    ...
                    SendPacket(0x09, concatBytes(getString(channel), length, data));
                }
                else
                {
                    SendPacket(0x09, concatBytes(getString(channel), data));
                }
